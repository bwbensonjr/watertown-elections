# election-results-website Specification

## Purpose

Defines the static, zero-build website that presents Watertown election results,
letting visitors drill down from elections to offices, view citywide totals and
per-precinct vote matrices, and explore a winner-per-precinct choropleth map over a
street basemap, all via shareable hash-based URLs.
